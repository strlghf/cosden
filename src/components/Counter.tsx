...
import { decrement, increment, incrementBy, decrementBy, incrementAsync, decrementAsync } from "../redux/state/counter/counterSlice";
  ...
  return (
    <div>
      ...
      <div>
        ...
        <button onClick={() => dispatch(decrementAsync(10))}>Decrement Async</button>
      </div>
    </div>
  )
}
